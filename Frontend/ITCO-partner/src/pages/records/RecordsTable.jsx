      ...
      <table className="min-w-400 w-full text-sm border border-gray-400 border-collapse">
        <thead className="bg-gray-50 text-gray-700">
          <tr>
            ...
            <Th rowSpan={1} colSpan={2} className="text-center">Bal. per stockcard</Th>
                    ...
                    <Td className="text-center">
                      {canManageRecords ? (
                        <div className="flex items-center justify-center gap-2">
                          <Button variant="ghost" type="button" onClick={() => onEdit?.(record.id)}>
                            Edit
                          </Button>
                          <Button variant="danger" type="button" onClick={() => onDelete?.(record.id)}>
                            Delete
                          </Button>
                        </div>
                      ) : (
